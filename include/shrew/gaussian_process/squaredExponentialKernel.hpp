...
namespace gaussian_process {
    namespace kernel {
        ...
        struct SEHyperparamsPartialDerivative : HyperparametersPartialDerivative{
          Eigen::MatrixXd lengthscale;
          Eigen::MatrixXd noise_stdv;
          Eigen::MatrixXd signal_stdv;

          SEHyperparamsPartialDerivative(int size) {
        ...
        class SquaredExponential : public Kernel {
          ...
          public:
            ...
            SquaredExponential(std::shared_ptr<Hyperparameters> hyperparameters_) {
              hyperparameters = *shrew::utils::cast_pointer<SEHyperparams>(hyperparameters_, "shrew::kernel::SquaredExponential(): hyperparameters_");
              hp_lower_bounds = *shrew::utils::cast_pointer<SEHyperparams>(hyperparameters_, "shrew::kernel::SquaredExponential(): hyperparameters_");
              hp_upper_bounds = *shrew::utils::cast_pointer<SEHyperparams>(hyperparameters_, "shrew::kernel::SquaredExponential(): hyperparameters_");
            ...
            std::shared_ptr<Hyperparameters> hp_upper_bounds_, std::vector<int> conditional_indices_) {
              hyperparameters = *shrew::utils::cast_pointer<SEHyperparams>(hyperparameters_, "shrew::kernel::SquaredExponential(): hyperparameters_");
              hp_lower_bounds = *shrew::utils::cast_pointer<SEHyperparams>(hp_lower_bounds_, "shrew::kernel::SquaredExponential(): hp_lower_bounds_");
              hp_upper_bounds = *shrew::utils::cast_pointer<SEHyperparams>(hp_upper_bounds_, "shrew::kernel::SquaredExponential(): hp_upper_bounds_");
