...
namespace gaussian_process {
    namespace kernel {
        double Matern::MaternEval(MaternSmoothness nu, double r, double l) {
            switch (nu) {
        ...
        double Matern::DerivativeMaternEval(MaternSmoothness nu, double r, double l) {
            switch (nu) {
        ...
        Eigen::MatrixXd Matern::DataKernelFunc(std::vector<double> hyperparams_, Eigen::VectorXd x) const {
        ...
        std::vector<Eigen::MatrixXd> Matern::DataKernelDerivatives(std::vector<double> hyperparams_, Eigen::VectorXd x) const {
