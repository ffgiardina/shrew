...
NormalDistribution::get_pd_operands() const {
...
RandomVariable<NormalDistribution> operator+(
  ...
  double mu =
      var_a.probability_distribution.mu + var_b.probability_distribution.mu;
  double sigma = sqrt(pow(var_a.probability_distribution.sigma, 2) +
                      pow(var_b.probability_distribution.sigma, 2));
  return RandomVariable<NormalDistribution>(
      NormalDistribution(mu, sigma, &(var_a.probability_distribution),
                         &(var_b.probability_distribution)));
};
...
RandomVariable<NormalDistribution> operator+(
  ...
  return RandomVariable<NormalDistribution>(
      NormalDistribution(var_a + var_b.probability_distribution.mu,
                         var_b.probability_distribution.sigma, 0,
                         &(var_b.probability_distribution)));
};
...
RandomVariable<NormalDistribution> operator+(
  ...
  return RandomVariable<NormalDistribution>(
      NormalDistribution(var_b + var_a.probability_distribution.mu,
                         var_a.probability_distribution.sigma,
                         &(var_a.probability_distribution), 0));
};
RandomVariable<NormalDistribution> operator-(
    double var_a, RandomVariable<NormalDistribution> const &var_b) {
  return RandomVariable<NormalDistribution>(
...
RandomVariable<NormalDistribution> operator-(
    RandomVariable<NormalDistribution> const &var_a, double var_b) {
  return RandomVariable<NormalDistribution>(
      NormalDistribution(var_a.probability_distribution.mu - var_b,
                         var_a.probability_distribution.sigma,
                         &(var_a.probability_distribution), 0));
};
...
RandomVariable<NormalDistribution> operator*(
  ...
  return RandomVariable<NormalDistribution>(
      NormalDistribution(mu, sigma, 0, &(var_b.probability_distribution)));
};
...
RandomVariable<NormalDistribution> operator*(
  ...
  return RandomVariable<NormalDistribution>(
      NormalDistribution(mu, sigma, &(var_a.probability_distribution), 0));
};
